		...
		<div id="content">
			...
			<div id="content_2">
				<div id="content-area">
					...
					<hr>
						<p>
							관리자가 확인 후 승인을 도와드립니다. 최대 7일까지 소요될 수 있습니다. <br>
							궁금한 사항은 1:1문의하기 게시판을 이용해주세요.
						</p>
					<hr>
					
					<div id="table-area">
						<form id="group-enroll-form" action="<%= contextPath %>/insert.gr" method="post" class="form-inline">
							...
							<table class="table">
								...
								<tr>
									<th>연락처 *</th>
									<td><input type="text" name="userPhone" placeholder="-포함" required></td>
								</tr>
								<tr>
									<th>사업자등록번호</th>
									<td><input type="text" name="groupEnrollno"></td>
								</tr>
								<tr>
									<th>공식사이트</th>
									<td><input type="text" name="groupUrl"></td>
								</tr>
								<tr>
									<th>참고사항</th>
									<td><textarea name="groupEtc" cols="80" rows="10" style="resize:none;"></textarea></td>
								</tr>
							</table>
							...
							<div id="button-area">
								<button type="button" class="btn" id="backBtn" onclick="goBack();">취소</button> &emsp;
