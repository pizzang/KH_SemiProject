        ...
        <div id="content_AR">
            ...
            <div id="review-img"style="overflow: hidden">
                <div class="slide-container" style="margin-left: 40px;">
                    <div class="slide-box">
                         <img id="titleImg" src="<%=contextPath%>/<%=list.get(0).getFilePath()+list.get(0).getChangeName()%>">
                      </div>
					<% for(int i = 1; i < list.size(); i++){ %>	     						
                       <div class="slide-box">
                           <img id="contentImg<%=i%>" src="<%=contextPath%>/<%=list.get(i).getFilePath()+list.get(i).getChangeName()%>">
                       </div>
					<%} %>
                </div>
